...
import com.shehata.pokedex.ui.components.FavouriteFloatingButton
    ...
    Scaffold(
        floatingActionButton =  {
            FavouriteFloatingButton(
                ...
                backgroundColor = state.pokemon?.types?.get(0)?.color ?: MaterialTheme.colors.background
            ) {
                actions(PokemonDetailsActions.SetFavourite(!isFavourite))
            }
        },
        modifier = Modifier
            .fillMaxSize()
